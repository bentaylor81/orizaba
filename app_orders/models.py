...
class OrderShipment(models.Model):
    ...
    delivery_tax_number = models.CharField(max_length=200, blank=True)
...
class Order(models.Model):
    ...
    delivery_firstname = models.CharField(max_length=35, blank=True) 
    delivery_lastname = models.CharField(max_length=35, blank=True) 
    delivery_address_1 = models.CharField(max_length=35, blank=True)
    delivery_address_2 = models.CharField(max_length=35, blank=True)
    delivery_city = models.CharField(max_length=35, blank=True)
    delivery_postcode = models.CharField(max_length=200, blank=True)
    delivery_country = models.CharField(max_length=200, blank=True)
    delivery_country_code = models.CharField(max_length=5, blank=True)
    delivery_email = models.CharField(max_length=200, blank=True)
    delivery_phone = models.CharField(max_length=200, blank=True)
    delivery_tax_number = models.CharField(max_length=200, blank=True, default='')
